    ...
    public simulateMatch(
      ...
      try {
        ...
        const matchObj = {
            ...
            seed: typeof match.seed === "number" && Number.isFinite(match.seed) && match.seed >= 0 ? match.seed : derivedSeed,
            date: new Date(),
            mapVeto: [],
            vetoComplete: match.vetoComplete ?? false,
            maps: (match.maps || []) as MapId[],
