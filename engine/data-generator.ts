...
export class DataGenerator {
  ...
  static generateExpandedTournaments(teams: Team[], selectedRegions: string[] = ["EU", "NA"]): Tournament[] {
    ...
    const majorTournaments = [
      { name: "IEM Katowice Major", startWeek: 8, tier: "s" as const, prizePool: 1250000 },
      { name: "PGL Copenhagen Major", startWeek: 24, tier: "s" as const, prizePool: 1250000 },
      { name: "ESL One Cologne", startWeek: 32, tier: "s" as const, prizePool: 1000000 },
      { name: "BLAST World Final", startWeek: 48, tier: "s" as const, prizePool: 1000000 },
    ]
    ...
    const aTierEvents = [
      { name: "ESL Pro League", region: "EU", startWeek: 4, prizePool: 750000 },
      { name: "IEM Dallas", region: "NA", startWeek: 16, prizePool: 500000 },
      { name: "BLAST Premier Spring", region: "EU", startWeek: 12, prizePool: 425000 },
      { name: "BLAST Premier Fall", region: "EU", startWeek: 36, prizePool: 425000 },
      { name: "Perfect World Shanghai", region: "ASIA", startWeek: 28, prizePool: 400000 },
    ]
