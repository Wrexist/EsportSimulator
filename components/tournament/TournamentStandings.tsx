...
function TournamentStandings({ tournament, matches, teams, playerTeamId, qualifiedTeamIds }: TournamentStandingsProps) {
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="overflow-hidden rounded-xl border border-white/10 bg-black/20">
                {/* Header */}
                <div className="grid grid-cols-[3rem_2fr_1fr_1fr_1fr_1fr] bg-white/5 text-[10px] font-bold uppercase tracking-wider text-white/50 py-3 px-4">
                    <div className="text-center">#</div>
                    <div className="text-left">Team</div>
                    <div className="text-center">W-L</div>
                    <div className="text-center">Diff</div>
                    <div className="text-center">Streak</div>
                    <div className="text-right">Prize/Qual</div>
                </div>
                    ...
                    {standings.map((team, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={cn(
                                    "grid grid-cols-[3rem_2fr_1fr_1fr_1fr_1fr] items-center py-3 px-4 text-sm hover:bg-white/5 transition-colors",
                                    getRowStyle(rank),
                                    isPlayer && "bg-cyan-500/10 border-l-2 border-l-cyan-400"
                                )}
                            >
